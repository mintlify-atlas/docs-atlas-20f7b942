...
description: "Set up Neo4j and Milvus, install Python dependencies with uv, choose a Graph RAG backend, and run your first multi-hop medical query in minutes."
---
