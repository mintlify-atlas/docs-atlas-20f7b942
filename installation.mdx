---
title: "Install Agentic Graph RAG for Medical Diagnosis"
...
```bash uv quickstart (alternative)
# Install uv directly from the official script (see https://github.com/astral-sh/uv)
