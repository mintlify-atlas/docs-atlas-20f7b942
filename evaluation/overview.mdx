...
description: "How the four agentic Graph RAG pipelines are evaluated against LightRAG, MiniRAG, PathRAG, and HyperGraphRAG baselines using five DeepEval metrics."
---
