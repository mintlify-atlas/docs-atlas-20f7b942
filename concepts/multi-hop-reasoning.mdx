...
description: "See how the agentic pipeline uses back-referenced sub-queries to perform iterative multi-hop reasoning across semantic and relational evidence."
---
