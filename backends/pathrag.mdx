...
description: "PathRAG organises the knowledge graph into high-level and low-level entity tiers and retrieves reasoning paths between entities rather than isolated nodes or edges."
---
