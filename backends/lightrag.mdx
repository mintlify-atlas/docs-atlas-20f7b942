...
description: "LightRAG builds a dual-level knowledge graph of entity mentions and concept clusters, retrieving context in hybrid mode via Neo4j and a vector index."
---
